...
public class DriverIntegrationTests {
    ...
    void shouldReturnDriverAllInfo() {
        ResponseEntity<DriverAllInfoDto> response =
                restTemplate.exchange("/api/drivers/1",
                        HttpMethod.GET,
                        getHeadersForRole("USER"),
    ...
    void shouldReturnNotFoundWhenDriverDoesNotExist() {
        ResponseEntity<DriverRaceDto> response =
                restTemplate.exchange("/api/drivers/100",
                        HttpMethod.GET,
                        getHeadersForRole("USER"),
                        DriverRaceDto.class);
    ...
    void shouldReturnNotFoundWhenRequestingRacesForNonExistingDriver() {
        ResponseEntity<DriverRaceDto> response =
                restTemplate.exchange("/api/drivers/100/races",
                        HttpMethod.GET,
                        getHeadersForRole("USER"),
                        DriverRaceDto.class);
    ...
    void shouldUpdateDriver() {
        ...
        ResponseEntity<DriverDto> response =
                restTemplate.exchange("/api/drivers/1",
                HttpMethod.PUT,
                getPostEntityWithRole(updatedDriver, "EMPLOYEE"),
                DriverDto.class);
